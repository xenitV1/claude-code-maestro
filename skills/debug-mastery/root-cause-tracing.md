...
2. If problem appears, it's in first half
3. Split that half, repeat
...
1. Create failing test (Phase 4)
2. Add defense-in-depth validation (see `@defense-in-depth.md`)
3. Verify with `@verification-mastery`
